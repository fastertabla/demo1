...
export default function EmbeddedTopLevel() {
  ...
  function initialRender(inRenderObj) {
    ...
    //console.log('*****' + JSON.stringify(thePConn.getCaseInfo()));
  ...
  function createAIP(optionClicked: string) {
    ...
    getSdkConfig().then(sdkConfig => {
      ...
      mashupCaseType = 'OD8Z9Y-Mortgage-Work-Helper';
      const options: any = {
      ...
      <div className={classes.resolutionPart}>
        <div className={classes.resolutionPartAccompanimentLeft}>
          <div className={classes.resolutionPartAccompanimentText}>
            ...
            <br />
            <br />
            Your Agreement in Principle is under review with the case reference AIP-2002. Representative from Lloyds bank will contact you with in the
